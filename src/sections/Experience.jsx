        ...
        <section className='c-space my-20'>
            <div className='w-full text-white'>
                ...
                <div className='grid lg:grid-cols-3 grid-cols-1 gap-5 mt-12'>
                    ...
                    {/* Enlarged Canvas section with height control */}
                    <div className='lg:col-span-1 col-span-full rounded-lg bg-black_200 border bg-border_300 h-[400px] sm:h-[500px] lg:h-full'>
                        <Canvas>
                    ...
                    <div className='bg-black_200 lg:col-span-2 col-span-full rounded-lg border bg-border_300'>
                            ...
                            {workExperiences.map(({ id, name, pos, duration, title, animation, icon }) => (
                                <div key={id} className='grid grid-cols-[auto_1fr] items-start gap-5 transition-all ease-in-out duration-500 cursor-pointer hover:bg-black rounded-lg sm:px-5 px-2.5 group'>
                                    ...
                                    <div className='sm:p-5 px-2.5 py-5'>
                                        ...
                                        <p className='group-hover:text-white transition ease-in-out duration-500 text-white_800'>{title}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
